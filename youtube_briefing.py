...
# Use the system CA bundle (if configured) so requests work behind
# environments with a custom/proxy certificate authority.
if os.environ.get("SSL_CERT_FILE"):
    httplib2.CA_CERTS = os.environ["SSL_CERT_FILE"]
